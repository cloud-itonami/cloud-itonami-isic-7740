# Operator Quickstart — Leasing of intellectual property and similar products, except copyrighted works

Shortest path from clone to a verified local dry-run for **ISIC 7740** (`cloud-itonami-isic-7740`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7740.git
cd cloud-itonami-isic-7740
```
...
- Blueprint governor key: `ip-lease-governor`
- Likely source path: `ipleaseops.governor.cljc`
